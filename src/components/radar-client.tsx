  ...
  useEffect(() => {
    ...
    void Promise.resolve(contexto.registerTool({
      ...
      async execute(entrada: unknown) {
        ...
        const permitidas = ["texto", "indiceMinimo", "municipio", "tipo", "variasUnidades", "expansao", "operacao24h", "qualidadeEvidencia", "faixa", "segmento", "somenteOportunidadesComerciais", "organizacao", "natureza", "tipoVinculo", "confiancaVinculo", "revisaoNecessaria", "somentePrivadasMultiUnidade", "ordem"];
