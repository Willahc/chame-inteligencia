    ...
    void Promise.resolve(contexto.registerTool({
      ...
      inputSchema: {
        ...
        properties: {
          ...
          possuiSinalPNCP: { type: "boolean" },
          possuiSinalMobilidadePNCP: { type: "boolean" },
          contratacaoPublicaRecente: { type: "boolean" },
          somenteVinculoPNCPExato: { type: "boolean" },
      ...
      async execute(entrada: unknown) {
        ...
        const permitidas = ["texto", "indiceMinimo", "municipio", "tipo", "variasUnidades", "expansao", "operacao24h", "qualidadeEvidencia", "faixa", "segmento", "somenteOportunidadesComerciais", "organizacao", "natureza", "tipoVinculo", "confiancaVinculo", "revisaoNecessaria", "somentePrivadasMultiUnidade", "coberturaMinima", "organizacaoOuIsolado", "possuiSinalPNCP", "possuiSinalMobilidadePNCP", "contratacaoPublicaRecente", "somenteVinculoPNCPExato", "ordem"];
        ...
        const novosFiltros: FiltrosRadar = {
          ...
          possuiSinalPNCP: typeof valor.possuiSinalPNCP === "boolean" ? valor.possuiSinalPNCP : undefined,
          possuiSinalMobilidadePNCP: typeof valor.possuiSinalMobilidadePNCP === "boolean" ? valor.possuiSinalMobilidadePNCP : undefined,
          contratacaoPublicaRecente: typeof valor.contratacaoPublicaRecente === "boolean" ? valor.contratacaoPublicaRecente : undefined,
          somenteVinculoPNCPExato: typeof valor.somenteVinculoPNCPExato === "boolean" ? valor.somenteVinculoPNCPExato : undefined,
        };
      ...
      <section aria-label="Filtros do radar" className="painel p-5">
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
          ...
          <div className="flex flex-wrap items-end gap-x-5 gap-y-3 xl:col-span-2">
            {[
              { campo: "variasUnidades", rotulo: "Várias unidades" },
              { campo: "expansao", rotulo: "Com expansão" },
              { campo: "operacao24h", rotulo: "Opera 24h" },
              { campo: "somentePrivadasMultiUnidade", rotulo: "Privadas multi-unidade" },
              { campo: "revisaoNecessaria", rotulo: "Revisão necessária" },
              { campo: "somenteOportunidadesComerciais", rotulo: "Somente oportunidades comerciais" },
              { campo: "possuiSinalPNCP", rotulo: "Com sinal PNCP" },
              { campo: "possuiSinalMobilidadePNCP", rotulo: "PNCP mobilidade" },
              { campo: "contratacaoPublicaRecente", rotulo: "PNCP recente (3m)" },
              { campo: "somenteVinculoPNCPExato", rotulo: "PNCP vínculo exato" },
            ].map(({ campo, rotulo }) => (
              <label className="flex min-h-11 cursor-pointer items-center gap-2 text-sm font-medium" key={campo}>
                <input
                  className="size-4 accent-[var(--azul)]"
                  type="checkbox"
                  checked={Boolean(filtros[campo as keyof FiltrosRadar])}
                  onChange={(evento) => alterar(campo as keyof FiltrosRadar, evento.target.checked)}
                />
                {rotulo}
              </label>
            ))}
