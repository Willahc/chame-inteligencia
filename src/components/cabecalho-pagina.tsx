    ...
    <header className="flex flex-col justify-between gap-4 border-b border-[var(--borda)] pb-7 sm:flex-row sm:items-end">
      <div>
        <div className="mb-3 flex flex-wrap items-center gap-3">
          ...
          <span className="text-sm text-[var(--texto-suave)]">{obterModoDados() === "MODO_DEMONSTRACAO" ? "5 contas simuladas · sem dados pessoais reais" : "Dados oficiais e evidências rastreáveis"}</span>
        </div>
